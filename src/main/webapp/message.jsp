	...
	<table width="920" border="0" align="center" cellpadding="0"
		...
		<tr height="35">
			...
			<td width="900"><img src="image/icon_1.gif" width="10"
				height="9">&nbsp;&nbsp;<a href="">首页</a> &gt; <a href="">客户留言</a>
			</td>
			<td width="10">&nbsp;</td>
		</tr>
	</table>
	...
	<table width="920" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<td align="center" valign="top">
				...
				<table width="90%" border="0" cellspacing="0" cellpadding="0">
					<form name="form1" method="post" action="<%=basePath%>message/add"
						onsubmit="return check(this);">

						<tr height="30">
							<td align="right">姓名：</td>
							<td align="left"><input name="name" type="text" size="20"
								maxlength="30" class="input2"></td>
						</tr>
						<tr height="30">
							<td align="right">电话：</td>
							<td align="left"><input name="phone" type="text" size="30"
								maxlength="30" class="input2"></td>
						</tr>
						<tr height="30">
							<td align="right">邮箱：</td>
							<td align="left"><input name="email" type="text" size="30"
								maxlength="50" class="input2"></td>
						</tr>
						<tr height="30">
							<td align="right">留言内容：</td>
							<td align="left"><textarea name="mess" cols="50" rows="8"
									class="input2"></textarea></td>
						</tr>
						<tr height="40">
							<td></td>
							<td align="left"><input type="submit" value=" 发送 ">&nbsp;&nbsp;&nbsp;&nbsp;
